...
f_ar2	cpfsgt	lcd_dshi	;ds>dd
	bra	f_ar1
f_arover1	bcf	STATUS,C
f_arover2	rrcf	lcd_arhi
	rrcf	lcd_arlo
	bcf	STATUS,C
f_arover3	rrcf	lcd_dshi
	rrcf	lcd_dslo
	movf	lcd_dslo,W
	subwf	PRODL
	movf	lcd_dshi,W
...
f_a22	cpfsgt	lcd_dshi	;ds>dd
	bra	f_a21
f_a2over1	bcf	STATUS,C
f_a2over2	rrcf	lcd_arhi
	rrcf	lcd_arlo
	bcf	STATUS,C
f_a2over3	rrcf	lcd_dshi
	rrcf	lcd_dslo
	movf	lcd_dslo,W
	subwf	PRODL
	movf	lcd_dshi,W
